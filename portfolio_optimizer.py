...
def download_data(data, period):
    ...
    if isinstance(data, dict):
	    ...
	    hist.index = pd.datetime(hist_index)
            dfs.append(hist)
...
sp500_dict = {
                ...
                'HDFC BANK LIMITED': 'HDB', 'HEALTHCARE REALTY TRUST INC.': 'HR', 'HEALTHCARE SERVICES GROUP INC.': 'HCSG', 'HEALTHPEAK PROPERTIES INC.': 'PEAK',
